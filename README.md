...
## Technical features
forms: created contact and enquiry page with forms so customers can reach out to us there.
sematic HTML: i used tags like main,header,nav and footer to organise the code
media: all businesses images are in the assets folder